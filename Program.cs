...
namespace NinetiesTV
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Print("All Names Combined with and", AllNamesWithCommasPlsAnd(shows));
            Print("Started in the Eighties", EightiesGenres(shows));
            Print("List of all Genres", UniqueGenres(shows));
            Print("Shows by Year", NumShowsFromRange(shows));
            Print("How long do I need to binge watch?", BingeTime(shows));
            Print("Year with the highest average IMDB", HighestAverageIMDB(shows));
        ...
        **************************************************************************************************/
        ...
        {
            return shows.OrderByDescending(s => s.EndYear).First().EndYear;
            //throw new NotImplementedException();
        }
        ...
        **************************************************************************************************/
        ...
        public static List<string> UniqueGenres(List<Show> shows)
        {
        ...
        public static List<string> NumShowsFromRange(List<Show> shows)
        {
        ...
        public static int HighestAverageIMDB(List<Show> shows)
        {
            return shows
